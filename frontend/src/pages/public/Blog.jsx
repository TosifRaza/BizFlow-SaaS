      ...
      <main className="flex-1 pt-24 pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-lg text-gray-500">Tips, guides, and updates for running your business better.</p>
          </div>

          <div className="mt-16 space-y-6">
            {POSTS.map((post) => (
              <article key={post.title} className="bg-white rounded-xl border border-gray-200 p-6 hover:shadow-md transition-shadow">
                <div className="flex items-center gap-3 mb-3">
                  <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100">{post.category}</span>
          ...
          <div className="mt-16 text-center">
            <p className="text-sm text-gray-500">More articles coming soon. <Link to="/" className="font-medium text-blue-600 hover:text-blue-700">Back to home</Link>.</p>
          </div>
        </div>
      </main>
